...
//ADS1220 Timings
#define SPI_TIME_START 1        //Delay time after CS has been set to low (at beginning of SPI communication) -- MIN 50 ns.
#define SPI_TIME_END 1          //Delay time before CS is set to high (at end of SPI communication) -- MIN 25 ns.
